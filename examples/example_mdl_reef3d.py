...
model = mdl.REEF3D(grid, start_time='2020-01-19T05:00', end_time='2020-01-19T06:00')
...
model.write_input_file(input_file_writer=inp.REEF3D(option='DiveMESH'))
model.write_input_file(input_file_writer=inp.REEF3D(option='REEF3D'))
