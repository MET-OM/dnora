...
# IMPORT dnora
# =============================================================================
from dnora import grd, mdl, ice, exp, wnd
# =============================================================================
# DEFINE GRID OBJECT
# =============================================================================
# Set grid definitions
grid = grd.Grid(lon=(29.67, 35.24), lat=(78.65, 80.62), name='Kvitoy')
...
model = mdl.NORA3(grid, start_time='2020-12-30T12:00',
                               end_time='2020-12-30T18:00')
# =============================================================================
