...
class Cacher:
    ...
    def empty(self):
        #return not glob.glob(f'{self.file_object.folder()}/{self.file_object.filename()[0:-3]}*')
...
#     aux_funcs.check_if_folder(main_folder)
#     cache_folder = f'{obj_type}_cache/{reader_name}'
#     aux_funcs.check_if_folder(cache_folder)
