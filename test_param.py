...
param_fetcherD = param.ParameterFromThredds('D_Breisundet', {'Hm0': 'hs', 'tm01': 'tm'}, dump_rest = True)
#param_fetcherF = param.ParameterFromThredds('F_Vartdalsfjorden', {'Hm0': 'hs', 'tm01': 'tm'}, dump_rest = True)
