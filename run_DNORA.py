...
#lon_min=5.39; lat_min=62.05; lon_max=6.8; lat_max=62.61
#project_name = 'Sulafjorden250'
#start_date = '2018-12-31T00:00' ; end_date = '2019-01-16T00:00'
#generate_wind_forcing_SWAN(project_name = project_name, dgm=250, start_date=start_date, end_date = end_date, lon_min=lon_min, lat_min=lat_min, lon_max=lon_max, lat_max=lat_max, NX = 291 , NY = 249)
