...
from DNORA import  generate_grid, generate_input_swn_file_SWAN , generate_input_NORA3spec_to_SWAN, generate_wind_forcing_SWAN,run_SWAN, generate_boundary_input                                 
...
#NX, NY = generate_grid(project_name=project_name, file_emodnet=file_emodnet, lon_min=lon_min, lat_min=lat_min, lon_max=lon_max, lat_max=lat_max, dgm=dgm, dbm=dbm, model='SWAN')
